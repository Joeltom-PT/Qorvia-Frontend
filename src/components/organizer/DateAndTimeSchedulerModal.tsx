...
const DateAndTimeSchedulerModal: React.FC<ModalProps> = ({ isOpen, onClose, onSave }) => {
  ...
  const handleInputChange = (index: number, field: keyof Schedule, value: any) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg">
        <h2 className="text-xl font-semibold mb-4 text-blue-900">Add Schedule</h2>
                ...
                <tr key={index} className="hover:bg-gray-100">
                  <td className="px-4 py-2">
                    <DatePicker
                      ...
                      onChange={(date: Date | null) => handleInputChange(index, 'date', date)}
                  ...
                  <td className="px-4 py-2">
                    <DatePicker
                      selected={schedule.timeRange ? schedule.timeRange[0] : null}
                      onChange={(start: Date | null) =>
                        handleInputChange(index, 'timeRange', [start, schedule.timeRange ? schedule.timeRange[1] : null])
                      }
                      showTimeSelect
                      showTimeSelectOnly
                      timeIntervals={15}
                  ...
                  <td className="px-4 py-2">
                    <DatePicker
                      selected={schedule.timeRange ? schedule.timeRange[1] : null}
                      onChange={(end: Date | null) =>
                        handleInputChange(index, 'timeRange', [schedule.timeRange ? schedule.timeRange[0] : null, end])
                      }
                      showTimeSelect
                      showTimeSelectOnly
                      timeIntervals={15}
