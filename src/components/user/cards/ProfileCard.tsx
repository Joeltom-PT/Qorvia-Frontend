...
import { Calendar, Wallet, Bell, LogOut, X } from 'lucide-react';
    ...
    <div className="bg-white border border-blue-900 rounded-[5px] shadow-md p-4 h-min w-full md:w-1/3">
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col w-full gap-2">
          <button className="bg-blue-100 text-blue-900 border-blue-900 border py-2 px-4 rounded flex items-center justify-center hover:bg-blue-200 transition-colors">
