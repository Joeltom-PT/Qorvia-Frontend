    ...
    <div className="flex h-screen bg-gray-100">
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} flex flex-col bg-indigo-900 text-white transition-all duration-300 ease-in-out`}>
        ...
        <nav className="flex-1">
          <SidebarItem icon={<Home size={20} />} text="Home" link="/admin/dashboard" expanded={sidebarOpen} />
          <SidebarItem icon={<Users size={20} />} text="Organizers" link="/admin/organizer-management" expanded={sidebarOpen} />
          <SidebarItem icon={<Calendar size={20} />} text="Events" link="/admin/event-management" expanded={sidebarOpen} />
          <SidebarItem icon={<Users size={20} />} text="Users Management" link="/admin/user-management" expanded={sidebarOpen} />
          <SidebarItem icon={<FileText size={20} />} text="Graph and Reports" link="/admin/graph-and-reports" expanded={sidebarOpen} />
          <SidebarItem icon={<DollarSign size={20} />} text="Payout Management" link="/admin/payout-management" expanded={sidebarOpen} />
        </nav>
        <div className="mt-auto border-t border-indigo-800">
          <SidebarItem icon={<HelpCircle size={20} />} text="Help" link="/admin/help" expanded={sidebarOpen} />
          <SidebarItem icon={<UserCircle size={20} />} text="Profile" link="/admin/profile" expanded={sidebarOpen} />
          <button
...
const SidebarItem: React.FC<SidebarItemProps> = ({ icon, text, link , expanded }) => (
  <Link to={link} className="flex items-center px-4 py-2 text-gray-300 hover:bg-indigo-800">
    {icon}
